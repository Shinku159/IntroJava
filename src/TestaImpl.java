...
public class TestaImpl {
    ...
    /*public static void main(String[] args) {
        ...
        Imovel casa = new Imovel(101, Util.CASA, "casa 3 dormitorios", "", 500000, 5,
                Calendar.getInstance(), v1);
        Imovel apto = new Imovel(102, Util.APTO, "apto 2 dormitorios", "", 350000, 4,
                Calendar.getInstance(), v2);
        Imovel lote = new Imovel(103, Util.LOTE, "lote 300 mts", "", 200000, 5,
                Calendar.getInstance(), v1);
